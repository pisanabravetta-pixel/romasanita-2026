...
export default function Footer() {
 const mesi = ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"];
  ...
  return (
   <footer style={{ background: '#2d3748', color: 'white', padding: '60px 0 30px', borderTop: '4px solid #3182ce', width: '100%', clear: 'both' }}>
...
>
  <img src="https://upload.wikimedia.org/wikipedia/commons/b/b8/2021_Facebook_icon.svg" width="18" height="18" alt="FB" /> 
  Facebook
</a>
        ...
        {/* COLONNA 2: PER GLI UTENTI (ORDINATA E COMPLETA) */}
         ...
         {/* SEZIONE GUIDE */}
           <li>
  <a href="/guide/prezzi-visite-specialistiche-roma" style={{ color: '#63b3ed', textDecoration: 'none', fontSize: '14px' }}>
    Guida: Prezzi Visite Roma
  </a>
</li> 
