...
{/* SEZIONE SOCIAL CON ICONE E LINK TESTATI */}
            ...
            <div style={{ display: 'flex', gap: '15px' }}>
             <a href="https://www.facebook.com/servizisaluteroma" target="_blank" rel="noopener noreferrer" style={{ color: '#a0aec0', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px' }}>
