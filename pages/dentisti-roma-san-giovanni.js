...
export default function DentistiRomaSanGiovanni() {
  // Automazione: filtra i dentisti con zona "San Giovanni"
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', color: '#333', backgroundColor: '#f9fafb', minHeight: '100vh' }}>
      <Head>
        <title>Dentista Roma San Giovanni | Studi Odontoiatrici</title>
        <meta name="description" content="Trova i migliori studi odontoiatrici a Roma San Giovanni. Contatti diretti, indirizzi e specialisti in zona Appia e San Giovanni." />
      </Head>
      ...
      <main style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px' }}>
        ...
        <h1 style={{ color: '#1e3a8a', fontSize: '28px', marginBottom: '10px' }}>Dentista a Roma San Giovanni</h1>
        <p style={{ color: '#666', marginBottom: '25px' }}>Elenco aggiornato degli studi dentistici nel quartiere San Giovanni.</p>
        ...
        <div style={{ backgroundColor: '#fff', padding: '15px', borderRadius: '10px', marginBottom: '25px', border: '1px solid #e2e8f0', display: 'flex', gap: '15px', alignItems: 'center' }}>
          ...
          <a href="/dentisti-roma-prati" style={{ color: '#2563eb', fontSize: '14px', textDecoration: 'none' }}>Prati</a>
        ...
        {dentistiZona.length > 0 ? (
          dentistiZona.map((s) => (
            <div key={s.id} style={{ backgroundColor: 'white', padding: '25px', borderRadius: '15px', marginBottom: '20px', border: '1px solid #e2e8f0' }}>
              ...
              <p style={{ margin: '5px 0' }}>📍 {s.indirizzo} (San Giovanni)</p>
          ...
          <div style={{ padding: '30px', textAlign: 'center', background: 'white', borderRadius: '10px', border: '1px dashed #ccc' }}>
            <p>Nessun dentista trovato per San Giovanni al momento.</p>
          </div>
        )}
      </main>
      ...
      <footer style={{ background: '#1a202c', color: 'white', padding: '30px 20px', textAlign: 'center', marginTop: '60px' }}>
        <p style={{ fontSize: '14px', margin: 0 }}>© 2026 ServiziSalute Roma - San Giovanni</p>
      </footer>
    </div>
  );
}
