    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#f1f5f9' }}>
      ...
      <main style={{ flex: '1 0 auto', maxWidth: '900px', margin: '0 auto', padding: '20px', width: '100%' }}>
        ...
        <div style={{ marginBottom: '25px' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '16px' }}>Cerca centri analisi e radiologia per quartiere.</p>
        </div>
        ...
        {/* ALTRE SPECIALISTICHE - RIPRISTINATE */}
      ...
      {/* FOOTER INTEGRALE DELLA HOME (COPIATO ESATTAMENTE) */}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px' }}>
            ...
            <div>
              ...
              <div style={{ marginTop: '20px', padding: '12px', backgroundColor: 'rgba(220, 38, 38, 0.1)', borderRadius: '8px', borderLeft: '3px solid #dc2626' }}>
                <p style={{ fontSize: '11px', color: '#feb2b2', margin: 0, fontWeight: 'bold', lineHeight: '1.4' }}>⚠️ ATTENZIONE: Richieste di specialisti in aumento a Roma Centro.</p>
              </div>
            </div>
            <div>
