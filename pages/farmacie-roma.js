        ...
        {loading ? (
          ...
          <div key={v.id} style={{ 
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              ...
              <a href={`https://wa.me/${v.whatsapp}`} style={{ flex: 1, minWidth: '100px', textAlign: 'center', background: '#22c55e', color: 'white', padding: '14px', borderRadius: '12px', textDecoration: 'none', fontWeight: 'bold' }}>WhatsApp</a>
            </div>
          </div>
        ))}
