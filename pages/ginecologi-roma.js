  ...
  return (
    <div style={{ fontFamily: '-apple-system, system-ui, sans-serif', backgroundColor: '#fff1f2', minHeight: '100vh' }}>
      <Head>
        ...
        <meta name="description" content="Trova i migliori ginecologi a Roma. Prenota visite, ecografie e pap-test nei principali quartieri della capitale." />
      </Head>

      <div style={{ backgroundColor: '#db2777', color: 'white', padding: '12px 0', textAlign: 'center', fontSize: '14px', fontWeight: 'bold' }}>🌸 GINECOLOGIA E OSTETRICIA A ROMA</div>
