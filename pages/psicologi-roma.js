  ...
  return (
    <div style={{ fontFamily: '-apple-system, system-ui, sans-serif', backgroundColor: '#f0fdfa', minHeight: '100vh', color: '#1a202c' }}>
      ...
      <div style={{ backgroundColor: '#0d9488', color: 'white', padding: '12px 0', textAlign: 'center', fontSize: '14px', fontWeight: 'bold' }}>
        🧠 PSICOLOGI E PSICOTERAPEUTI A ROMA – GENNAIO 2026
      </div>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '20px' }}>
        ...
        {/* LISTA CON BADGE */}
        <h2 style={{ fontSize: '22px', color: '#1a202c', marginBottom: '20px', fontWeight: '700' }}>Professionisti disponibili ora</h2>
        {loading ? (
          ...
          medici.map((v) => (
            <div key={v.id} style={{ backgroundColor: 'white', padding: '30px', borderRadius: '24px', marginBottom: '20px', border: v.is_top ? '3px solid #0d9488' : '1px solid #e2e8f0', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.05)' }}>
              ...
              {/* 🔹 BADGET COMPETENZE AGGIUNTI */}
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '12px' }}>
                <span style={{ backgroundColor: '#f0fdfa', color: '#0d9488', padding: '4px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: '800', border: '1px solid #ccfbf1' }}>🛡️ ANSIA E STRESS</span>
                <span style={{ backgroundColor: '#f0fdfa', color: '#0d9488', padding: '4px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: '800', border: '1px solid #ccfbf1' }}>👥 TERAPIA DI COPPIA</span>
                <span style={{ backgroundColor: '#f0fdfa', color: '#0d9488', padding: '4px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: '800', border: '1px solid #ccfbf1' }}>🧠 PSICOTERAPIA</span>
              </div>
          ...
          <div style={{ textAlign: 'center', padding: '40px', backgroundColor: 'white', borderRadius: '24px' }}>Nessun professionista trovato a Roma.</div>
        )}
        ...
        <section style={{ marginTop: '40px', padding: '25px', backgroundColor: 'white', borderRadius: '24px', border: '1px dashed #0d9488' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '10px' }}>
            {altreSpecialistiche.map(s => (
              <a key={s.nome} href={s.url} style={{ color: '#0d9488', textDecoration: 'none', fontSize: '14px', fontWeight: '500' }}>• {s.nome} a Roma</a>
            ))}
          </div>
        </section>
        ...
        <section style={{ marginTop: '30px', backgroundColor: 'white', padding: '35px', borderRadius: '24px', marginBottom: '50px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              <p style={{ fontWeight: 'bold', color: '#1a202c', marginBottom: '8px' }}>Come si sceglie lo psicologo adatto?</p>
              <p style={{ color: '#64748b' }}>È importante valutare la specializzazione del professionista rispetto al problema (es. ansia, problemi di coppia) e la vicinanza geografica al proprio quartiere.</p>
            </div>
          </div>
        </section>
      </main>

      {/* FOOTER INTEGRALE (Con widget per i professionisti) */}
