...
export const DENTISTI = [
  ...
  { id: 7, nome: "Studio Dentistico Dr. Elio Forcella", zona: "Prati", indirizzo: "Via Virginio Orsini, 19", slug: "/dentisti-roma-prati", isTop: false }
];
...
export const FARMACIE = [
  ...
  { id: 4, nome: "Farmacia della Fontana", zona: "Centro", indirizzo: "Via del Babuino, 100", slug: "/farmacie-roma-centro", info: "Aperta tutti i giorni", isTop: false }
];
...
export const DIAGNOSTICA = [
  ...
  { id: 3, nome: "Artemisia Lab Villa Massimo", zona: "Roma Nord", indirizzo: "Via di Villa Massimo, 37", slug: "/diagnostica-roma-nord", info: "Risonanza Magnetica", isTop: false }
];
...
export const VISITE = [
  ...
  { id: 3, nome: "Dr. Paolo Rossi Cardiologo", zona: "Prati", indirizzo: "Via Ottaviano, 42", slug: "/cardiologi-roma-prati", info: "Malattie apparato cardiovascolare", isTop: false }
];
