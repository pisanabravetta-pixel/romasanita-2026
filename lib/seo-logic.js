...
export const getDBQuery = (slug) => {
  ...
  const mapping = {
    'visite-specialistiche': { cat: 'specialistica', spec: 'specialistica', colore: '#0891b2' },
    'dentisti':              { cat: 'dentist',        spec: 'dentist',        colore: '#0f766e' },
    'farmacie':              { cat: 'farmac',         spec: 'farmac',         colore: '#15803d' },
    'cardiologi':            { cat: 'cardio',         spec: 'cardio',         colore: '#dc2626' },
    'psicologi':             { cat: 'psico',          spec: 'psico',          colore: '#7c3aed' },
    'dermatologi':           { cat: 'dermato',        spec: 'dermato',        colore: '#be185d' },
    'ginecologi':            { cat: 'gineco',         spec: 'gineco',         colore: '#db2777' },
    'nutrizionisti':         { cat: 'nutri',          spec: 'nutri',          colore: '#d97706' },
