 ...
 * VERSIONE CORRETTA E CHIUSA - NO ERROR RIGA 131
 */
...
export const getDBQuery = (slug) => {
  ...
  const mapping = {
    'dentisti': { cat: 'dentist', spec: 'dentist' },      // Prende Dentista, Dentisti, Dentist
    'farmacie': { cat: 'farmac', spec: 'farmac' },       // Prende Farmacia, Farmacie, Farmacista
    'cardiologi': { cat: 'cardio', spec: 'cardio' },     // Prende Cardiologo, Cardiologia
    'psicologi': { cat: 'psico', spec: 'psico' },       // Prende Psicologo, Psicoterapeuta
    'dermatologi': { cat: 'dermato', spec: 'dermato' },  // Prende Dermatologo, Dermatologia
    'ginecologi': { cat: 'gineco', spec: 'gineco' },     // Prende Ginecologo, Ginecologia
    'nutrizionisti': { cat: 'nutri', spec: 'nutri' },    // Prende Nutrizionista, Nutrizionisti
    'oculisti': { cat: 'oculist', spec: 'oculist' },     // Prende Oculista, Oculisti
    'ortopedici': { cat: 'ortoped', spec: 'ortoped' },   // Prende Ortopedico, Ortopedici
    'diagnostica': { cat: 'diagnost', spec: 'diagnost' },// Prende Diagnostica, Diagnostici
...
// Questa è la lista unica che comanderà tutto il sito
...
// LISTA DELLE CATEGORIE UFFICIALI (Per Sitemap e Navigazione Automatica)
