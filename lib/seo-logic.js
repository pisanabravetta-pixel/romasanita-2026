...
export const getDBQuery = (slug) => {
  ...
  const mapping = {
    'visite-specialistiche': { cat: 'specialistica', spec: 'specialistica' },
    'dentisti': { cat: 'dentist', spec: 'dentist' },
    'farmacie': { cat: 'farmac', spec: 'farmac' },
    'cardiologi': { cat: 'cardio', spec: 'cardio' },
    'psicologi': { cat: 'psico', spec: 'psico' },
    'dermatologi': { cat: 'dermato', spec: 'dermato' },
    'ginecologi': { cat: 'gineco', spec: 'gineco' },
    'nutrizionisti': { cat: 'nutri', spec: 'nutri' },
    'oculisti': { cat: 'oculist', spec: 'oculist' },
    'ortopedici': { cat: 'ortoped', spec: 'ortoped' },
    'diagnostica': { cat: 'diagnost', spec: 'diagnost' },
    'servizi-domicilio': { cat: 'domicilio', spec: 'domicilio' }
  };

 
  
  return mapping[cleanSlug] || { cat: 'specialistica', spec: 'specialistica' };
}
...
"text": f.a
    ...
    // Dati per TE (da usare nel .map della pagina)
    faqRaw: renderedFaqs,
    canonical: pageUrl
  };
};
