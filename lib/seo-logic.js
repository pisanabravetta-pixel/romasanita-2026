...
export const getDBQuery = (slug) => {
  if (!slug) return { cat: '', spec: '', elastic: '' };
  const cleanSlug = slug.replace('-roma', '');
  
  const mapping = {
    'dentisti': { cat: 'dentisti', spec: 'dentista', root: 'dentist' },
    'farmacie': { cat: 'farmacie', spec: 'farmacia', root: 'farmac' }, 
    'cardiologi': { cat: 'visite-specialistiche', spec: 'cardiologo', root: 'cardiolog' },
    'psicologi': { cat: 'visite-specialistiche', spec: 'psicologo', root: 'psicolog' },
    'dermatologi': { cat: 'visite-specialistiche', spec: 'dermatologo', root: 'dermatolog' },
    'ginecologi': { cat: 'visite-specialistiche', spec: 'ginecologo', root: 'ginecolog' },
    'nutrizionisti': { cat: 'visite-specialistiche', spec: 'nutrizionista', root: 'nutrizion' },
    'oculisti': { cat: 'visite-specialistiche', spec: 'oculista', root: 'oculist' },
    'ortopedici': { cat: 'visite-specialistiche', spec: 'ortopedico', root: 'ortoped' },
    'diagnostica': { cat: 'diagnostica', spec: 'centro diagnostico', root: 'diagnost' },
    'servizi-domicilio': { cat: 'Servizi a Domicilio', spec: 'domicilio', root: 'domicilio' }
  };

  const res = mapping[cleanSlug] || { cat: cleanSlug, spec: cleanSlug, root: cleanSlug };
  return res;
};
...
// Fine dell'oggetto e delle funzioni...
// Assicurati che non ci sia testo libero qui sotto!

export { getSchemas, getDBQuery, formatZona };
