...
export const getDBQuery = (slug) => {
  ...
  const mapping = {
    ...
    'cardiologo': { cat: 'visite-specialistiche', spec: 'cardiologo' },
    'psicologo': { cat: 'visite-specialistiche', spec: 'psicologo' },
    'dermatologo': { cat: 'visite-specialistiche', spec: 'dermatologo' },
