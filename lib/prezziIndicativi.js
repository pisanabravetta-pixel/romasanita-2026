export const prezziIndicativi = {
  ...
  // Servizi a Domicilio (Copre sia con spazi che con trattino)
  'servizi a domicilio': [
  ...
  'visite specialistiche': [ { servizio: "Visita specialistica in studio", min: 60, max: 120 } ],
  'specialisti': [ { servizio: "Visita specialistica in studio", min: 60, max: 120 } ],
